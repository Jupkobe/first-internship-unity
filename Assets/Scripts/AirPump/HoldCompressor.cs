...
public class HoldCompressor : MonoBehaviour
{
    public Camera cam;
    public GameObject objectToHold, fuel, C_base;
    ...
    void OnTriggerEnter(Collider c)
    {
        ...
        else if (c.gameObject.name == "BlowgunPos"){
            isHolding = false;
            C_base.GetComponent<Collider>().enabled = false;
        }
    }
}
